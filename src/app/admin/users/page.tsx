    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900">Gebruikers ({users.length})</h1>
        </div>
        <button
      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div className="grid grid-cols-4 px-4 py-3 bg-gray-50 border-b border-gray-100 text-xs font-semibold text-gray-500 uppercase tracking-wide">
          <div>Naam</div>
          <div>Email</div>
          <div>Rol</div>
        ...
        {users.map(u => (
          <div key={u.id} className="grid grid-cols-4 px-4 py-3 border-b border-gray-50 last:border-0 items-center">
